    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: Text(item.description ?? 'No description available',
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
                style: AppTextStyles.regular16
                    .copyWith(color: AppColors.secondary, fontSize: 14.sp)),
          ),
          // SizedBox(height: 12.h),
          const BuildCustomizeButton(),
          Expanded(child: SizedBox(child: BuildPriceSection(item: item))),
        ],
      ),
    );
  }
